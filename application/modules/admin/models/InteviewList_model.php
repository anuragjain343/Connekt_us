...
class InteviewList_model extends CI_Model {
    ...
    private function posts_get_query(){
       ...
       $this->db->select('`interview`.`interviewer_name`,`interview`.`location`,`interview`.`date`,`interview`.`time`,`request`.`requestId`,`request`.`is_finished`,`request`.`request_by`,`request`.`request_for`,`user`.`fullName`,`user_for`.`fullName` as Name');

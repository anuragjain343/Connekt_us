...
class JobTitle_list_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = JOB_TITLES;
    var $column_order = array('jobTitleId','jobTitleName','userType','status'); //set column field database for datatable orderable
    var $column_search = array('jobTitleName'); //set column field database for datatable searchable
    var $order = array('jobTitleName' => 'ASC');  // default order
    var $where = '';

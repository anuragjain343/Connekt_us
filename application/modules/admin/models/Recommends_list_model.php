...
class Recommends_list_model extends CI_Model {
    ...
    var $order = array('rec.recommendId' => 'DESC');  // default order
    var $where = '';
    ...
    function prepare_query(){
        ...
        if($this->userType == 'business'){
            $where['rec.recommend_for'] = $this->userId;
        }else{
            $where['rec.recommend_by'] = $this->userId;
        }
        $this->db->select('rec.*,u.userId, u.fullName,NOW() as today_datetime,(case 

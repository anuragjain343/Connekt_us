...
class Strength_list_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = STRENGTHS;
    var $column_order = array('strengthId','strengthName','status'); //set column field database for datatable orderable
    var $column_search = array('strengthName'); //set column field database for datatable searchable
    var $order = array('strengthName' => 'ASC');  // default order
    var $where = '';

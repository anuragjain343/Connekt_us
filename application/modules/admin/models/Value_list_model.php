...
class Value_list_model extends CI_Model {

    //var $table , $column_order, $column_search , $order =  '';
    var $table = VALUE;
    var $column_order = array('valueId','valueName','status'); //set column field database for datatable orderable
    var $column_search = array('valueName'); //set column field database for datatable searchable
    var $order = array('valueName' => 'ASC');  // default order
    var $where = '';

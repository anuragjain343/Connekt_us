...
class Requests extends CommonService{
    ...
    function makeRequest_post(){ //make interview request..
        ...
        {       
            ...
            $user_info =  $this->common_model->getsingle(USERS, array('userId'=>$requestedFor), 'userId, deviceToken,isNotify,userType,fullName,email');
            ...
            //Email send when interviwe request generate -by anurag
           
             $send= array();
             $send['email']             = $user_info->email;
             $send['fullName']          = $user_info->fullName;
             $send['request_by']        = $this->authData->fullName;
             $send['interviewer_name']  = $dataRequest['interviewer_name'];
             $send['date']              = $dataRequest['date'];
             $send['time']              = $dataRequest['time'];
             $send['location']          = $dataRequest['location'];

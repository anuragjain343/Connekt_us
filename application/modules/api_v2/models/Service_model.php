    ...
    */
    ...
    function userInfo($where){
            ...
            if($userType->userType == 'business'){
                    $this->db->select('u.userId,u.isVerified,u.fullName,u.businessName,u.email,u.userType,u.authToken,u.status,u.crd,u.deviceToken,u.deviceType,u.isProfile,u.isNotify,u.isNotifyEmail,COALESCE(job.jobTitleName,"") as jobTitleName,COALESCE(CEIL(AVG(r.rating)/0.5) * 0.5, "") as rating,COALESCE(u.phone,"") as phone,COALESCE(aos.specializationName,"") as specializationName,um.linkedIn_profile_link,
                ...
                $this->db->select('u.userId,u.isVerified,u.fullName,u.businessName,u.email,u.userType,u.authToken,u.status,u.crd,u.deviceToken,u.phone,u.deviceType,u.isProfile,u.isNotify,u.isNotifyEmail,COALESCE(aos.specializationName,"") as specializationName,COALESCE(job.jobTitleName,"") as jobTitleName,um.linkedIn_profile_link,
            ...
            $wherePofile = array('user_id'=>$newData);   
            ...
            $whereBilling = array('user_id'=>$newData);   
            ...
            $res->is_billing_complete = $is_billing_complete;
        ...
        if($res->num_rows()){
            ...
            if($result->status == 1)
            {
                ...
                if(password_verify($data['password'], $result->password)){
                    ...
                    if($updateData){
                        return array('returnType'=>'SL','userInfo'=>$this->userInfo(array('userId'=>$result->userId),$result->userId));
                    }
                    else{
                        return FALSE;
                    }

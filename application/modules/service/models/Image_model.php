...
class Image_model extends CI_Model
{
	...
	function updateContent($file,$folder,$path=FALSE){
		...
		$allowed_types = "doc|txt|pdf|DOC|TXT|PDF|docx|DOCX"; 
		
		$config = array(
			'upload_path'   	=> $realpath.$folder,
			'allowed_types' 	=> $allowed_types,
			'max_size' 			=> "12000",// Can be set to particular file size , here it is 12 MB
			'max_width'			=> "7000",
			'max_height'		=> "7000",
			'encrypt_name'		=> FALSE,
			'overwrite'		 	=> false,

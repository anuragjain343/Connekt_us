                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <h3 style="color: #333; font-size: 22px; font-weight: normal; margin: 0; text-transform: capitalize;">Landing Page Email</h3>
                            <p style="text-align: left; color: #333; font-size: 16px; line-height: 28px;">Hello Admin,</p>
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">Someone has contacted us!</p>
